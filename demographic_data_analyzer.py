...
def calculate_demographic_data(print_data=True):
    ...
    race_count = df.groupby('race').agg({'race':'count'})
    ...
    top_IN_occupation = df.loc[(df['native-country'] == "India") & (df['salary'] == ">50K")].groupby('occupation').agg(count = ('occupation','count')).sort_values(by = 'count', ascending = False).reset_index()['occupation'].loc[0]
